...
public class ShowErrorMsgDialog extends Dialog {

    public Button btn_ok;

    public ShowErrorMsgDialog(Context context) {
        super(context);
    }
    ...
    public void createDilog (Context context , String msg){
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.dialog_error_msg, null);
